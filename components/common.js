...
export function headerComment(packageName) {
  return `// Package ${packageName} provides primitives to interact with the AsyncAPI messaging API.
//
// Code generated by github.com/arthurspa/go-watermill-template latest version. DO NOT EDIT.`
}